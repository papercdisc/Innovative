...
public class PlayerHealth : Health
{
    ...
    public float activeOverhealthSafeTime { get; private set; }

    [SerializeField] private float overhealthTimerBuffer = 0.5f;
    private float activeOverhealthTimerBuffer;
    ...
    private float activeRegenBuffer;
    ...
    public void RTHealthRegen() // (REAL-TIME) constant regen after not taking damage
    {
